...
class CNFTest {
    ...
    void evalTest() {
        ...
        TruthAssignment tau1 = new TruthAssignment(new ArrayList<>(List.of(q)));
        TruthAssignment tau2 = new TruthAssignment(new ArrayList<>(List.of(p)));
        TruthAssignment tau3 = new TruthAssignment(new ArrayList<>(Arrays.asList(p,q)));
        TruthAssignment tau4 = new TruthAssignment(new ArrayList<>(Arrays.asList(p,r)));
        TruthAssignment tau5 = new TruthAssignment(new ArrayList<>(List.of(r)));
        TruthAssignment tau6 = new TruthAssignment(new ArrayList<>(Arrays.asList(q,r)));
