...
class DPLLTest {
    ...
    void SATTest1() {
        ...
        // DPLL class
        DPLLRecursive solver = new DPLLRecursive(Arrays.asList(p,q,r,s));
    ...
    void SATTest2() {
        ...
        // DPLL class
        DPLLRecursive solver = new DPLLRecursive(Arrays.asList(p,q));
    ...
    void SATTest7() {
        ...
        // DPLL class
        DPLLRecursive solver = new DPLLRecursive(Arrays.asList(p,q,r));
    ...
    void SATTest8() {
        ...
        // DPLL class
        DPLLRecursive solver = new DPLLRecursive(Arrays.asList(n11, n12, n21, n22));
